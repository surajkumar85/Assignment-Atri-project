...
class Atri:
	...
	@property
	def cologo(self):
		self._getter_access_tracker["cologo"] = {}
		return self._cologo
	@cologo.setter
	def cologo(self, new_state):
		self._setter_access_tracker["cologo"] = {}
		global default_state
		self._cologo = Image(new_state, default_state["cologo"])
